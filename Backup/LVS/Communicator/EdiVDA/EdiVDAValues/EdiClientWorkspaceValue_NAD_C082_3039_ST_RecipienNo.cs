...
{
    public class EdiClientWorkspaceValue_NAD_C082_3039_ST_RecipienNo
    {
        //-- alt muss aber erhlaten bleiben
        public const string const_EdiAdrWorkspaceAssign_NAD_C082_3039_ST_RecipienNo = "#EdiAdrWorkspaceAssign_NAD_C082_3039_RecipienNo#";
        public const string const_EdiClientWorkspaceValue_NAD_C082_3039_ST_RecipienNo = "#EdiClientWorkspaceValue_NAD_C082_3039_RecipienNo#";
        public const string const_EdiClientWorkspaceValue_Property = "NAD+ST";
        public static string Execute(clsASN myAsn, clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            {
                EdiClientWorkspaceValueViewData eawaVD = new EdiClientWorkspaceValueViewData(iAdrId, iAsnArtId, iWorkspace, EdiClientWorkspaceValue_NAD_C082_3039_ST_RecipienNo.const_EdiClientWorkspaceValue_Property, (int)myAsn.BenutzerID);
