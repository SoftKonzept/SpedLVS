...
{
    public class LOC_C519
    {
        internal clsEdiSegmentElement SegElement;
        internal LOC LOC;
        public const string Kennung_C519 = "C519";
        ...
        public LOC_C519(LOC myEdiElement)
        {
        ...
        internal const string Kennung_3223 = "3223";
        private string _f_3223 = string.Empty;
        public string f_3223
        {
            get
            {
                _f_3223 = string.Empty;
                if ((this.sef3223 is clsEdiSegmentElementField) && (this.sef3223.ID > 0))
                {
                    clsEdiVDAAssignValueAlias v = new clsEdiVDAAssignValueAlias(string.Empty, this.LOC.EDICreate, this.sef3223, string.Empty, string.Empty);
                    _f_3223 = v.ReturnValue;
                }
                return _f_3223;
            }
        }
        public clsEdiSegmentElementField sef3223
        {
            get
            {
                ...
                {
                    tmpSef = this.SegElement.ListEdiSegmentElementFields.FirstOrDefault(x => x.Shortcut == LOC_C519.Kennung_3223);
                }
                return tmpSef;
            }
        }
        ...
        /// 
        /// </summary>
        internal const string Kennung_3222 = "3222";
        private string _f_3222 = string.Empty;
        public string f_3222
        {
            get
            {
                _f_3222 = string.Empty;
                if ((this.sef3222 is clsEdiSegmentElementField) && (this.sef3222.ID > 0))
                {
                    clsEdiVDAAssignValueAlias v = new clsEdiVDAAssignValueAlias(string.Empty, this.LOC.EDICreate, this.sef3222, string.Empty, string.Empty);
                    _f_3222 = v.ReturnValue;
                }
                return _f_3222;
            }
        }
        public clsEdiSegmentElementField sef3222
        {
            get
            {
                clsEdiSegmentElementField tmpSef = new clsEdiSegmentElementField();
                if (this.SegElement.ListEdiSegmentElementFields.Count > 0)
                {
                    tmpSef = this.SegElement.ListEdiSegmentElementFields.FirstOrDefault(x => x.Shortcut == LOC_C519.Kennung_3222);
                }
                return tmpSef;
            }
        }
        ...
        private void CreateValue()
        {
            ...
            if (!f_3222.Equals(clsEdiVDAValueAlias.const_VDA_Value_NotUsed))
            {
                this.Value += UNA.const_Trennzeichen_Gruppe_Doppelpunkt + this.f_3222;
            }
        }
