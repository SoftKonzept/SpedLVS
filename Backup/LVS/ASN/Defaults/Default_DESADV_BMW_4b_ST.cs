...
{
    public class Default_DESADV_BMW_4b_ST
    {
        public static bool CreateDefault_DESADV_BMW_4b_ST(int myDestAdrID, Globals._GL_USER myGLUser)
        {
            bool bReturn = false;
            ...
            List<clsEdiSegmentElementField> ListFields = EdiFields.GetDefaultEdiFieldsList(constValue_AsnArt.const_Art_DESADV_BMW_4b_ST);
            ...
            if (ListFields.Count > 0)
            {
                ...
                {
                    bReturn = clsSQLCOM.ExecuteSQLWithTRANSACTION(strSql, "EdiBMW_4b_ST", myGLUser.User_ID);
                }
            }
            return bReturn;
        }
