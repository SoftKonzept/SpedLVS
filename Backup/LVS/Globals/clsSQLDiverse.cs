...
namespace LVS
{
    public class clsSQLconComDiverse : clsSQLCOM
    {
        public clsSQLconComDiverse(string myServer, string myDatabase, string myUser, string myPassword)
        {
            _server = myServer;
        ...
        //
        public static bool ExecuteSQL(string strSQL, decimal decBenutzer, clsSQLconComDiverse sqlDiv)
        {
            bool retVal = true;
            //--- initialisierung des sqlcommand---
            SqlCommand Command_1 = new SqlCommand();
            clsSQLconComDiverse sql = sqlDiv;
            sql.init();
        ...
        //
        //
        public static bool ExecuteSQLWithTRANSACTION(string strSQL, string strTActionName, decimal decBenutzer, clsSQLconComDiverse sqlDiv)
        {
        ...
        public static object ExecuteSQLWithTRANSACTIONGetObject(string strSQL, string strTActionName, decimal decBenutzer, clsSQLconComDiverse sqlDiv)
        {
            bool bTActionOK = true;
        ...
        ///<remarks></remarks>
        public static string ExecuteSQLWithTRANSACTIONGetValue(string strSQL, string strTActionName, decimal decBenutzer, clsSQLconComDiverse sqlDiv)
        {
            bool bTActionOK = true;
        ...
        ///<summary>ctrFaktLager / tscbMandanten_SelectedIndexChanged</summary>
        ///<remarks></remarks>
        public static DataTable ExecuteSQLWithTRANSACTIONGetDataTable(string strSQL, string strTActionName, string strTableName, decimal decBenutzer, clsSQLconComDiverse sqlDiv)
        {
        ...
        //
        //
        public static DataTable ExecuteSQL_GetDataTable(string strSQL, decimal decBenutzer, string strTableName, clsSQLconComDiverse sqlDiv)
        {
            DataTable dt = new DataTable(strTableName);
            dt.Clear();
        ...
        //
        //
        public static string ExecuteSQL_GetValue(string strSQL, decimal decBenutzer, clsSQLconComDiverse sqlDiv)
        {
            bool retVal = true;
        ...
        //
        public static bool ExecuteSQL_GetValueBool(string strSQL, decimal decBenutzer, clsSQLconComDiverse sqlDiv)
        {
            bool retVal = true;
            bool boExist = false;
            string strSql = string.Empty;
