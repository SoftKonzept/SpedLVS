...
namespace Sped4.Classes.Update
{
    public class up1307
    {
        ...
        /// <returns></returns>
        /// 
        public const string const_up1307 = "1307";
        public static string SqlString()
        {
            ...
            sql = "IF COL_LENGTH('LEingang','PrintActionByScanner') IS NULL " +
                  "BEGIN " +
                    "ALTER TABLE [LEingang] ADD [PrintActionByScanner] [bit] NOT NULL DEFAULT ((0)); " +
                  "END ";
            return sql;
        }
        /// <summary>
