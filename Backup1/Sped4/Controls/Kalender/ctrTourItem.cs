...
{
    public partial class ctrTourItem : AFKalenderItem
    {
        public const string const_ctrName = "KalenderTourItem";
        ...
        public ctrTourItem(frmDispo _Kalender)
        {
            InitializeComponent();
            Kalender = _Kalender;
            ...
            this.Name = ctrTourItem.const_ctrName;
        ...
        public void DeleteTourFromDispoKalender()
        {
            if (GL_User.write_Disposition)
            {
                if (clsTour.ExistTourID(this.GL_User, this.Tour.ID))
                {
                    ...
                    this.ctrCalRowRefresh();
                    if (Functions.IsCtrAlreadyOpen(ref this.ctrMenu) != null)
                    {
                        this.Kalender.AuftragCtr.InitDGV();
                        this.Kalender.AuftragCtr.dgv.Refresh();
                    }
                }
            }
            else
        ...
        private void miDetails_Click(object sender, EventArgs e)
        {
            ...
            {
                //OpenFrmKommiDetailsPanel();
                this.Kalender._ctrTourItem = this;
        ...
        {
            this.ctrMenu.OpenScanFrm(this.Kommission.Tour.Auftrag.ID, this.Kommission.AuftragPosTableID, 0, 0, this);
        }
        //
