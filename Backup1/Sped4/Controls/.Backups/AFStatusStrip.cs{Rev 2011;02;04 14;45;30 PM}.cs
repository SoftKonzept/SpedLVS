...
{
    public partial class AFStatusStrip :StatusStrip
    {
        public AFStatusStrip()
        {
            InitializeComponent();
        ...
        private void AFStatusStrip_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
        {
            Color ColorTop1;
            Color ColorTop2;
            Color ColorBot1;
            ...
            //so könnte man mit Alphachanel Gegenstände optisch in das Control Zeichnen
            //Rectangle oRectPic = new Rectangle(this.Width - 100,
            //                                    this.Height - 21,
