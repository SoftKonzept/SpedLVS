...
namespace Sped4.TelerikControls
{
    public class DragAndDropRadGrid : RadGridView
    {
        ...
        private void svc_PreviewDragDrop(object sender, RadDropEventArgs e)
        {
            ...
            var targetGrid = dropTarget.ElementTree.Control as DragAndDropRadGrid;
            if (targetGrid == null)
            {
                return;
            }

            var dragGrid = rowElement.ElementTree.Control as DragAndDropRadGrid;
        ...
        private void MoveRows(DragAndDropRadGrid targetGrid, DragAndDropRadGrid dragGrid, IList<GridViewRowInfo> dragRows, int index)
        {
