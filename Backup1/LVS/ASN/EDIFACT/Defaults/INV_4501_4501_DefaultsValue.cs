...
{
    public class INV_4501_4501_DefaultsValue
    {
        public string ValueArt { get; set; } = string.Empty;
        public string Value { get; set; } = string.Empty;
        public INV_4501_4501_DefaultsValue(Addresses myAdr, AsnArt myAsnArt, EdiSegmentElementFields myEdiSegmentField)
        {
            ...
            switch (myAsnArt.Typ)
            {
                ...
                case constValue_AsnArt.const_ArtBeschreibung_EDIFACT_INVRPT_D96A:
                    ValueArt = clsEdiVDAValueAlias.const_cFunction_EdifactINVRPT_INV_4501_4501_MessageType;
                    Value = string.Empty;
                    break;
            }
        }
