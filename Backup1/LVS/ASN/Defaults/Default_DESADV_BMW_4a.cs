...
{
    public class Default_DESADV_BMW_4a
    {
        public static bool CreateDESADV_BMW_4a(int myDestAdrID, Globals._GL_USER myGLUser)
        {
            bool bReturn = false;
            ...
            List<clsEdiSegmentElementField> ListFields = EdiFields.GetDefaultEdiFieldsList(constValue_AsnArt.const_Art_DESADV_BMW_4a);
            ...
            if (ListFields.Count > 0)
            {
                ...
                {
                    bReturn = clsSQLCOM.ExecuteSQLWithTRANSACTION(strSql, "EdiBMW_4a", myGLUser.User_ID);
                }
            }
            return bReturn;
        }
