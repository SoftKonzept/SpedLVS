...
{
    public partial class ctrVDAClientWorkspaceValueSelectToCopy : UserControl
    {
        ...
        public ctrVDAClientWorkspaceValueSelectToCopy(ctrMenu myMenu, clsASNWizzard myAsnWizz)
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void ctrVDAClientOutSelectToCopy_Load(object sender, EventArgs e)
        {
            InitDgv();
        }
        /// <summary>
        ...
        private void InitDgv()
        {
            ...
            dtDgvSource = clsVDAClientWorkspaceValue.GetVDAClientWorkspaceValueByAdrId(this.ctrMenue.GL_User, this.asnWizz.VdaWorkspaceValue.AdrID);
        ...
        private void TakeOver()
        {
            ...
            if ((dtSelected.Rows.Count > 0) && (this.asnWizz.AuftragggeberAdr.ID > 0))
            {
                ...
                {
                    clsVDAClientWorkspaceValue.InsertShapeByRefAdr(ListSelectedID
