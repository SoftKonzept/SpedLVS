...
namespace TwainLib
{
    ...
    public class Twain
    {
        ...
        public Twain()
        {
            ...
            appid.Manufacturer = "ComTEC Nöker GmbH";
            appid.ProductFamily = "Sped4";
            appid.ProductName = "Sped4";
        ...
        public void Acquire()
        {
            ...
            TwCapability cap = null;
            //Typ Farbe
            //0=Schwarz/Weiss /Text
            //1 =Grey
            //2 = Colour

            cap = new TwCapability(TwCap.IPixelType, 0);
