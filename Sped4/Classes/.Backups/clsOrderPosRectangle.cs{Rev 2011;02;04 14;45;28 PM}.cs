...
namespace Sped4.Classes
{
  class clsOrderPosRectangle
  {
    ...
    private Int32 _AuftragScanID;
    private Int32 _OrderPosRecID;
    ...
    public Int32 AuftragScanID
    {
      get { return _AuftragScanID; }
      set { _AuftragScanID = value; }
    }
    public Int32 OrderPosRecID
    {
    ...
    //
    public static void DeleteRectanglePosByAuftragAuftragPos(Int32 Auftrag, Int32 AuftragPos)
    {
        //--- initialisierung des sqlcommand---
        SqlCommand Command = new SqlCommand();
        Command.Connection = Globals.SQLcon.Connection;
    ...
    //----------- Check Verwendung ------------------- 
    //
    public static bool IsAuftragAuftragPosIn(Int32 Auftrag, Int32 AuftragPos)
    {
      bool IsIn = true;
      try
      {
