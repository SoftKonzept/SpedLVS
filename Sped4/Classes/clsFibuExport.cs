...
namespace Sped4.Classes
{
    class clsFibuExport
    {
        ...
        private decimal _ID;
        private decimal _Rechnungen_ID;         //ID DB Rechnungen
        private decimal _Frachten_ID;           //ID DB Frachten für Gutschriften
        ...
        //aus der Typenbibl.
        private decimal _BelegNummer;     //RG-GS ID
        private DateTime _Belegdatum;   // RG Datum
        private DateTime _Valutadatum;
        private decimal _OPNummer;
        private decimal _KontoNummer;   //KD ID - Debitoren Nummer
        ...
        public decimal OPNummer
        {
            get { return _OPNummer; }
            set { _OPNummer = value; }
        }
        public decimal KontoNummer
        {
