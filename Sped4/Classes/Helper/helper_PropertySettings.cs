...
{
    public class helper_PropertySettings
    {
        ...
        {
            Sped4.Properties.Settings.Default.BackColor = helper_PropertySettings.DefaultBackColor;
            Sped4.Properties.Settings.Default.BaseColor = helper_PropertySettings.DefaultBaseColor;
            Sped4.Properties.Settings.Default.BaseColor2 = helper_PropertySettings.DefaultBaseColor2;
            Sped4.Properties.Settings.Default.EffectColor = helper_PropertySettings.DefaultEffectColor;
            Sped4.Properties.Settings.Default.EffectColor2 = helper_PropertySettings.DefaultEffectColor2;
            myMain.RefreshColor();
        }
