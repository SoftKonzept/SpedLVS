...
namespace LVS
{
    public class clsTextDatei
    {
        ...
        public string ReadLine(String sFilename, Int32 iLine)
        {
            string sContent = "";
            float fRow = 0;
            if (File.Exists(sFilename))
        ...
        public void WriteLine(String sFilename, Int32 iLine, string sLines, bool bReplace)
        {
            string sContent = "";
            ...
            if (sCols.Length >= iLine)
            {
                ...
                sContent = "";
                for (Int32 x = 0; x < sCols.Length - 1; x++)
                {
                    sContent += sCols[x] + "\r\n";
                }
            ...
            {
                for (Int32 x = 0; x < iLine - sCols.Length; x++)
                    sContent += "\r\n";
