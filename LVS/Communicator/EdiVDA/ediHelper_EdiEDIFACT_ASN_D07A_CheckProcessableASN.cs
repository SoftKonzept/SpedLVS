            ...
            try
            {
                if (File.Exists(myFilePathName))
                {
                       ...
                       )
                    {
                        ...
                        //string strDESADV_D07ACheck = string.Empty;
                        //strDESADV_D07ACheck = tmpList.FirstOrDefault(x => x.Contains(strTmpCheck));
                        //if (strDESADV_D07ACheck != null)
                        //{
                        //    string strToCheck = string.Empty;
                        //    UNH uNH = new UNH(strDESADV_D07ACheck, myJob.ASNFileTyp);
                        //    if (uNH != null)
                        //    {
                        //        if (uNH.S009 != null)
                        //        {
                        ...
                        //        }
                        //    }
                        //    bIsDESADV_D07A = (strToCheck.Contains(ediHelper_EdiEDIFACT_ASN_D07A_CheckProcessableASN.const_UNH_S009));
                        //}
                        ...
                        myReturn = bIsDESADV_D07A; // dicSenderVerweis.ContainsKey(strVerweisCheck);
                        //if (!bVersenderOK)
                        //{
