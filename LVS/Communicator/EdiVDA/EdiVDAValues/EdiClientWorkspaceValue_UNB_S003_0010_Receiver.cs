...
{
    public class EdiClientWorkspaceValue_UNB_S003_0010_Receiver
    {
        //-- alt muss aber erhlaten bleiben neu EdiClientWorkspaceValue_UNB_S003_0010_Client
        public const string const_EdiAdrWorkspaceAssign_UNB_S003_0010_Receiver = "#EdiAdrWorkspaceAssign_UNB_S003_0010_Receiver#";
        public const string const_EdiClientWorkspaceValue_UNB_S003_0010_Receiver = "#EdiClientWorkspaceValue_UNB_S003_0010_Receiver#";
        public const string const_EdiClientWorkspaceValue_Property = "UNB#S003#0010";
        public static string Execute(clsASN myAsn, clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            {
                EdiClientWorkspaceValueViewData eawaVD = new EdiClientWorkspaceValueViewData(iAdrId, iAsnArtId, iWorkspace, iAuftraggeberId, EdiClientWorkspaceValue_UNB_S003_0010_Receiver.const_EdiClientWorkspaceValue_Property, (int)myAsn.BenutzerID);
