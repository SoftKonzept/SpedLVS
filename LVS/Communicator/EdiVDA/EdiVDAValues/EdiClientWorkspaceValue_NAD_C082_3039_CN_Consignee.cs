...
{
    public class EdiClientWorkspaceValue_NAD_C082_3039_CN_Consignee
    {
        public const string const_EdiClientWorkspaceValue_NAD_C082_3039_Consignee = "#EdiClientWorkspaceValue_NAD_C082_3039_Consignee#";
        public const string const_EdiClientWorkspaceValue_Property = "NAD+CN";
        public static string Execute(clsASN myAsn, clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            {
                EdiClientWorkspaceValueViewData eawaVD = new EdiClientWorkspaceValueViewData(iAdrId, iAsnArtId, iWorkspace, iAuftraggeberId, EdiClientWorkspaceValue_NAD_C082_3039_CN_Consignee.const_EdiClientWorkspaceValue_Property, (int)myAsn.BenutzerID);
