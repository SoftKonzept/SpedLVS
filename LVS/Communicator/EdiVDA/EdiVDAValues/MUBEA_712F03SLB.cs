...
{
    public class MUBEA_712F03SLB
    {
        public const string const_MUBEA_712F03SLB = "#MUBEA_712F03SLB#";
        ...
        public static string Execute(clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            switch (myAsnTyp.Typ)
            {
                ...
                case clsASNTyp.const_string_ASNTyp_TSL:
                    ...
                    {
                        //strTmp = myLager.Eingang.ExTransportRef;
                ...
                case clsASNTyp.const_string_ASNTyp_RLE:
                    ...
                    {
                        strTmp = "510" + myLager.Ausgang.SLB.ToString();
                    }
                    break;
            }
            return strTmp;
