...
{
    public class EdiClientWorkspaceValue_NAD_C082_3039_SE_Seller
    {
        public const string const_EdiClientWorkspaceValue_NAD_C082_3039_Seller = "#EdiClientWorkspaceValue_NAD_C082_3039_Seller#";
        public const string const_EdiClientWorkspaceValue_Property = "NAD+SE";
        public static string Execute(clsASN myAsn, clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            {
                EdiClientWorkspaceValueViewData eawaVD = new EdiClientWorkspaceValueViewData(iAdrId, iAsnArtId, iWorkspace, iAuftraggeberId, EdiClientWorkspaceValue_NAD_C082_3039_SE_Seller.const_EdiClientWorkspaceValue_Property, (int)myAsn.BenutzerID);
