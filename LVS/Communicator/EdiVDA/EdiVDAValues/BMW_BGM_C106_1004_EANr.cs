...
{
    public class BMW_BGM_C106_1004_EANr
    {
        public const string const_BMW_BGM_C106_1004_EANr = "#BMW_BGM_C106_1004_EANr#";

        /// <summary>
        ///                 AVIS
        ///                 EANr ohne Prefix 
        ///                 mit interner BMW Kennzeichnung
        ///                 51
        /// </summary>
        ...
        public static string Execute(clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            switch (myAsnTyp.Typ)
            {
                ...
                case clsASNTyp.const_string_ASNTyp_TSL:
                    ...
                    {
                        strTmp = "51" + myLager.Eingang.LEingangID.ToString("000000");
                    }
                    break;
                ...
                case clsASNTyp.const_string_ASNTyp_UBL:
                    if (myLager.Eingang is clsLEingang)
                    {
                        strTmp = "52" + myLager.Eingang.LEingangID.ToString("000000");
                    }
                    break;
