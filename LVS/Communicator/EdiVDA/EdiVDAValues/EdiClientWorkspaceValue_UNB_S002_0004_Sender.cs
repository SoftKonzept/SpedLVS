...
{
    public class EdiClientWorkspaceValue_UNB_S002_0004_Sender
    {
        //-- alt muss aber erhlaten bleiben
        public const string const_EdiAdrWorkspaceAssign_UNB_S002_0004_Sender = "#EdiAdrWorkspaceAssign_UNB_S002_0004_Sender#";
        public const string const_EdiClientWorkspaceValue_UNB_S002_0004_Sender = "#EdiClientWorkspaceValue_UNB_S002_0004_Sender#";
        public const string const_EdiClientWorkspaceValue_Property = "UNB#S002#0004";
        public static string Execute(clsASN myAsn, clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            {
                EdiClientWorkspaceValueViewData eawaVD = new EdiClientWorkspaceValueViewData(iAdrId, iAsnArtId, iWorkspace, iAuftraggeberId, EdiClientWorkspaceValue_UNB_S002_0004_Sender.const_EdiClientWorkspaceValue_Property, (int)myAsn.BenutzerID);
