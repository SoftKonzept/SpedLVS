...
{
    public class EdiClientWorkspaceValue_NAD_C082_3039_DP_DeliveryPart
    {
        public const string const_EdiClientWorkspaceValue_NAD_C082_3039_DeliveryPart = "#EdiClientWorkspaceValue_NAD_C082_3039_DeliveryPart#";
        public const string const_EdiClientWorkspaceValue_Property = "NAD+DP";
        public static string Execute(clsASN myAsn, clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            {
                EdiClientWorkspaceValueViewData eawaVD = new EdiClientWorkspaceValueViewData(iAdrId, iAsnArtId, iWorkspace, iAuftraggeberId, EdiClientWorkspaceValue_NAD_C082_3039_DP_DeliveryPart.const_EdiClientWorkspaceValue_Property, (int)myAsn.BenutzerID);
