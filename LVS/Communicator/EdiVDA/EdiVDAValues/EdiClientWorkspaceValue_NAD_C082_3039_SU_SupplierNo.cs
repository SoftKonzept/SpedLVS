...
{
    public class EdiClientWorkspaceValue_NAD_C082_3039_SU_SupplierNo
    {
        public const string const_EdiClientWorkspaceValue_NAD_C082_3039_SupplierNo = "#EdiClientWorkspaceValue_NAD_C082_3039_SupplierNo#";
        public const string const_EdiClientWorkspaceValue_Property = "NAD+SU";
        public static string Execute(clsASN myAsn, clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            {
                EdiClientWorkspaceValueViewData eawaVD = new EdiClientWorkspaceValueViewData(iAdrId, iAsnArtId, iWorkspace, iAuftraggeberId, EdiClientWorkspaceValue_NAD_C082_3039_SU_SupplierNo.const_EdiClientWorkspaceValue_Property, (int)myAsn.BenutzerID);
