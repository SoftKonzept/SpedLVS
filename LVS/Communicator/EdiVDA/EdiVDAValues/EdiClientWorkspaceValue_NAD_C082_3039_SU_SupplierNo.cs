...
namespace LVS.Communicator.EdiVDA.EdiVDAValues
{
    public class EdiClientWorkspaceValue_NAD_C082_3039_SU_SupplierNo
    {
        ...
        public static string Execute(clsASN myAsn, clsASNTyp myAsnTyp, clsLagerdaten myLager)
        {
            ...
            {
                EdiClientWorkspaceValueViewData eawaVD = new EdiClientWorkspaceValueViewData(iAdrId, iAsnArtId, iWorkspace, EdiClientWorkspaceValue_NAD_C082_3039_SU_SupplierNo.const_EdiClientWorkspaceValue_Property, (int)myAsn.BenutzerID);
