...
{
    public class UNB_S003_0010_DefaultsValue
    {
        public string ValueArt { get; set; } = string.Empty;
        public string Value { get; set; } = string.Empty;
        public UNB_S003_0010_DefaultsValue(Addresses myAdr, AsnArt myAsnArt)
        {
            ValueArt = clsEdiVDAValueAlias.const_cFunction_EdiClientWorkspaceValue_UNB_S003_0010_Receiver;
            Value = string.Empty; ;
