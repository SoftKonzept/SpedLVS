...
namespace LVS.ASN.EDIFACT.Initialisierung
{
    public class InitUNA
    {
        ...
        public InitUNA(AsnArt myAsnArt)
        {
            ...
            ese.EdiSegmentId = 0;
            ese.Name = UNA.Name;
            ese.Description = "SERVICE STRING ADVICE";
            ese.Position = 1;
            ese.Created = DateTime.Now;
            ese.tmpId = 0;
            ese.Code = ediSegmentVD.EdiSegment.Code;
            ese.SortId = 1;
            ese.Kennung = UNA.Name + " | " + UNA.Name;
            ese.IsActive = true;
            ...
            esef.SortId = 1;
            esef.Kennung = ese.Kennung + " | " + UNA.Name;
            esef.EdiSegmentId = 0;
            ...
            ese.Id = 0;
            ese.EdiSegmentId = 0;
            ese.Name = UNA.Name; // "UNA1";
            ese.Description = "Component data element separator";
            ese.Position = 1;
            ese.Created = DateTime.Now;
            ese.tmpId = 0;
            ese.Code = ediSegmentVD.EdiSegment.Code;
            ese.SortId = 1;
            ese.Kennung = UNA.Name + " | " + ese.Code;
            ese.IsActive = true;
            ese.ListEdiSegmentElementFields = new List<EdiSegmentElementFields>();
            ...
            esef.Format = string.Empty;
            esef.Description = string.Empty;
            esef.constValue = "UNA1";
            esef.Position = 1;
            esef.Created = DateTime.Now;
            esef.FormatString = string.Empty;
            esef.Code = ediSegmentVD.EdiSegment.Code;
            esef.SortId = 1;
            esef.Kennung = ese.Kennung + " | " + "UNA1";
            esef.EdiSegmentId = 0;
            esef.AsnArtId = (int)asnArt.Id;
            ese.ListEdiSegmentElementFields.Add(esef);
            ...
            ese.Id = 0;
            ese.EdiSegmentId = 0;
            ese.Name = UNA.Name;// "UNA2";
            ese.Description = "Data element separator";
            ese.Position = 1;
            ese.Created = DateTime.Now;
            ese.tmpId = 0;
            ese.Code = ediSegmentVD.EdiSegment.Code;
            ese.SortId = 1;
            ese.Kennung = UNA.Name + " | " + "UNA2";
            ese.IsActive = true;
            ese.ListEdiSegmentElementFields = new List<EdiSegmentElementFields>();
            ...
            esef.Format = string.Empty;
            esef.Description = string.Empty;
            esef.constValue = "UNA2";
            esef.Position = 1;
            esef.Created = DateTime.Now;
            esef.FormatString = string.Empty;
            esef.Code = ediSegmentVD.EdiSegment.Code;
            esef.SortId = 1;
            esef.Kennung = ese.Kennung + " | " + "UNA2";
            esef.EdiSegmentId = 0;
            esef.AsnArtId = (int)asnArt.Id;
            ese.ListEdiSegmentElementFields.Add(esef);
            ...
            ese.EdiSegmentId = 0;
            ese.Name = "UNA3";
            ese.Description = "Decimal notation";
            ese.Position = 1;
            ese.Created = DateTime.Now;
            ese.tmpId = 0;
            ese.Code = ediSegmentVD.EdiSegment.Code;
            ese.SortId = 1;
            ese.Kennung = UNA.Name + " | " + "UNA3";
            ese.IsActive = true;
            ese.ListEdiSegmentElementFields = new List<EdiSegmentElementFields>();
            ...
            esef.Format = string.Empty;
            esef.Description = string.Empty;
            esef.constValue = "UNA3";
            esef.Position = 1;
            esef.Created = DateTime.Now;
            esef.FormatString = string.Empty;
            esef.Code = ediSegmentVD.EdiSegment.Code;
            esef.SortId = 1;
            esef.Kennung = ese.Kennung + " | " + "UNA3";
            esef.EdiSegmentId = 0;
            esef.AsnArtId = (int)asnArt.Id;
            ese.ListEdiSegmentElementFields.Add(esef);
            ...
            ese.EdiSegmentId = 0;
            ese.Name = "UNA4";
            ese.Description = "Release indicator";
            ese.Position = 1;
            ese.Created = DateTime.Now;
            ese.tmpId = 0;
            ese.Code = ediSegmentVD.EdiSegment.Code;
            ese.SortId = 1;
            ese.Kennung = UNA.Name + " | " + "UNA4";
            ese.IsActive = true;
            ese.ListEdiSegmentElementFields = new List<EdiSegmentElementFields>();
            ...
            esef.Format = string.Empty;
            esef.Description = string.Empty;
            esef.constValue = "UNA4";
            esef.Position = 1;
            esef.Created = DateTime.Now;
            esef.FormatString = string.Empty;
            esef.Code = ediSegmentVD.EdiSegment.Code;
            esef.SortId = 1;
            esef.Kennung = ese.Kennung + " | " + "UNA4";
            esef.EdiSegmentId = 0;
            esef.AsnArtId = (int)asnArt.Id;
            ese.ListEdiSegmentElementFields.Add(esef);
            ...
            ese.EdiSegmentId = 0;
            ese.Name = "UNA5";
            ese.Description = "Reserved for future use ";
            ese.Position = 1;
            ese.Created = DateTime.Now;
            ese.tmpId = 0;
            ese.Code = ediSegmentVD.EdiSegment.Code;
            ese.SortId = 1;
            ese.Kennung = UNA.Name + " | " + "UNA5";
            ese.IsActive = true;
            ese.ListEdiSegmentElementFields = new List<EdiSegmentElementFields>();
            ...
            esef.Format = string.Empty;
            esef.Description = string.Empty;
            esef.constValue = "UNA5";
            esef.Position = 1;
            esef.Created = DateTime.Now;
            esef.FormatString = string.Empty;
            esef.Code = ediSegmentVD.EdiSegment.Code;
            esef.SortId = 1;
            esef.Kennung = ese.Kennung + " | " + "UNA5";
            esef.EdiSegmentId = 0;
            esef.AsnArtId = (int)asnArt.Id;
            ese.ListEdiSegmentElementFields.Add(esef);
            ...
            ese.EdiSegmentId = 0;
            ese.Name = "UNA6";
            ese.Description = "Segment terminator";
            ese.Position = 1;
            ese.Created = DateTime.Now;
            ese.tmpId = 0;
            ese.Code = ediSegmentVD.EdiSegment.Code;
            ese.SortId = 1;
            ese.Kennung = UNA.Name + " | " + "UNA6";
            ese.IsActive = true;
            ese.ListEdiSegmentElementFields = new List<EdiSegmentElementFields>();
            ...
            esef.Format = string.Empty;
            esef.Description = string.Empty;
            esef.constValue = "UNA6";
            esef.Position = 1;
            esef.Created = DateTime.Now;
            esef.FormatString = string.Empty;
            esef.Code = ediSegmentVD.EdiSegment.Code;
            esef.SortId = 1;
            esef.Kennung = ese.Kennung + " | " + "UNA6";
            esef.EdiSegmentId = 0;
            esef.AsnArtId = (int)asnArt.Id;
            ese.ListEdiSegmentElementFields.Add(esef);
