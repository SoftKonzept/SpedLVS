...
namespace LVS.ASN.EDIFACT.Initialisierung
{
    public class InitQTY
    {
        ...
        public InitQTY(AsnArt myAsnArt, string myCode)
        {
            ...
            ese.Id = 0;
            ese.EdiSegmentId = 0;
            ese.Name = QTY_C186.Kennung;
            ese.Description = "Quantity qualifier";
            ese.Position = 1;
            ese.Created = DateTime.Now;
            ese.tmpId = 0;
            ese.Code = ediSegmentVD.EdiSegment.Code;
            ...
            esef.Id = 0;
            esef.EdiSemgentElementId = 0;
            esef.Shortcut = QTY_C186.Kennung_6063;
            esef.Name = "Quantity qualifier";
            esef.Status = "R";
            esef.Format = "a3";
            ...
            esef.Id = 0;
            esef.EdiSemgentElementId = 0;
            esef.Shortcut = QTY_C186.Kennung_6060;
            esef.Name = "Quantity";
            esef.Status = "R";
            esef.Format = "a15";
            esef.Description = string.Empty;
            ...
            esef.Id = 0;
            esef.EdiSemgentElementId = 0;
            esef.Shortcut = QTY_C186.Kennung_6411;
            esef.Name = "Measure unit qualifier ";
            esef.Status = "R";
            esef.Format = "a3";
            esef.Description = string.Empty;
            esef.constValue = string.Empty;
