...
{
    public class Default_DESADV_BMW_6_UB
    {
        public static bool CreateDefault_DESADV_BMW_6_UB(int myDestAdrID, Globals._GL_USER myGLUser)
        {
            bool bReturn = false;
            ...
            List<clsEdiSegmentElementField> ListFields = EdiFields.GetDefaultEdiFieldsList(constValue_AsnArt.const_Art_DESADV_BMW_6_UB);
            ...
            if (ListFields.Count > 0)
            {
                ...
                {
                    bReturn = clsSQLCOM.ExecuteSQLWithTRANSACTION(strSql, "EdiBMW_6UB", myGLUser.User_ID);
                }
            }
            return bReturn;
        }
