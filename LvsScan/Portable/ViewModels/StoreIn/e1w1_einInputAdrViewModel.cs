...
{
    public class e1w1_einInputAdrViewModel : BaseViewModel
    {
        public e1w1_einInputAdrViewModel()
        {
            Init();
        }
        public e1w1_einInputAdrViewModel(enumStoreInArt myStoreInArt)
        {
        ...
        public string SearchString
        {
            get
            {
                searchString = "e1w1_einInputAdrViewModel";
                return searchString;
            }
