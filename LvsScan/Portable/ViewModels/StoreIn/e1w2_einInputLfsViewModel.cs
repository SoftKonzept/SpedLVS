...
{
    public class e1w2_einInputLfsViewModel : BaseViewModel
    {
        public e1w2_einInputLfsViewModel()
        {
            Init();
        }
        public e1w2_einInputLfsViewModel(enumStoreInArt myStoreInArt)
        {
        ...
        {
            IsBusy = false;
            IsBtnDateEnabled = true;
            IsBtnLfsEnabled = true;
            IsInputDateEnabled = false;
            IsInputLfsEnabled = false;
        }


        public enumStoreInArt_Steps CurrentStep = enumStoreInArt_Steps.wizStepInputLfs;
        ...
        private DateTime _EADate;// = new DateTime(1900,1,1);
        public DateTime EADate
        {
            get { return _EADate; }
            set
            {
                SetProperty(ref _EADate, value);
                if (
                        (_EADate > MinDate) &&
                        (!_EADate.Equals(SelectedEingang.Eingangsdatum))
                   )
                {
                    Eingaenge tmpEA = SelectedEingang.Copy();
                    if (tmpEA.Id > 0)
                    {
                        tmpEA.Eingangsdatum = _EADate;
                    }
                    SelectedEingang = tmpEA.Copy();
                    IsInputDateEnabled = false;
                }
        ...
        private bool _IsBtnDateEnabled = false;
        public bool IsBtnDateEnabled
        {
            get { return _IsBtnDateEnabled; }
            set { SetProperty(ref _IsBtnDateEnabled, value); }
        }
        private bool _IsInputDateEnabled = true;
        public bool IsInputDateEnabled
        {
            get { return _IsInputDateEnabled; }
            set
            {
                SetProperty(ref _IsInputDateEnabled, value);
                BackgroundColorInputDate = ValueToColorConverter.ButtonBackgroundColor(_IsInputDateEnabled);
            }
        }
        private System.Drawing.Color _BackgroundColorInputDate = ValueToColorConverter.ButtonBackgroundColor(false);
        public System.Drawing.Color BackgroundColorInputDate
        {
            get { return _BackgroundColorInputDate; }
            set { SetProperty(ref _BackgroundColorInputDate, value); }
        }
        ...
        public string LfsNr
        {
            ...
            set
            {
                SetProperty(ref _LfsNr, value);
                if (!_LfsNr.Equals(SelectedEingang.LfsNr))
                {
                    Eingaenge tmpEA = SelectedEingang.Copy();
                    if (tmpEA.Id > 0)
                    {
        ...
        private bool _IsBtnLfsEnabled = false;
        public bool IsBtnLfsEnabled
        {
            get { return _IsBtnLfsEnabled; }
            set { SetProperty(ref _IsBtnLfsEnabled, value); }
        }

        private bool _IsInputLfsEnabled = true;
        public bool IsInputLfsEnabled
        {
            get { return _IsInputLfsEnabled; }
            set
            {
                SetProperty(ref _IsInputLfsEnabled, value);
                BackgroundColorInputLfs = ValueToColorConverter.ButtonBackgroundColor(_IsInputLfsEnabled);
            }
        }
        private System.Drawing.Color _BackgroundColorInputLfs = ValueToColorConverter.ButtonBackgroundColor(false);
        public System.Drawing.Color BackgroundColorInputLfs
        {
            get { return _BackgroundColorInputLfs; }
            set { SetProperty(ref _BackgroundColorInputLfs, value); }
        }
