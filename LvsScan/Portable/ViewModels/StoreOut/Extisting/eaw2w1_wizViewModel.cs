...
{
    public class eaw2w1_wizViewModel : BaseViewModel
    {

        public eaw2w1_wizViewModel()
        {
        ...
        public async Task<bool> UpdateArticleScanCheck()
        {
            ...
            //resArticle = new ResponseArticle();
            //resArticle = result;
            //if (resArticle.Success)
            //{
            //    //// -- get changed List for Article 
            //    //ResponseAusgang resAusgang = new ResponseAusgang();
            //    //resAusgang.Ausgang = SelectedAusgang;

            //    //api_Ausgang _apiAusgang = new api_Ausgang();
            //    //var resultList = _apiAusgang.GET_AusgangList_Open();
            //    //resAusgang = new ResponseAusgang();
            //    //resAusgang = resultList.Copy();
