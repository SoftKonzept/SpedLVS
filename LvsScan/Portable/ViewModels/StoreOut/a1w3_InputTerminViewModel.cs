...
{
    public class a1w3_InputTerminViewModel : BaseViewModel
    {

        public a1w3_InputTerminViewModel()
        {
            StoreOutArt = enumStoreOutArt.NotSet;
            Init();
        }
        public a1w3_InputTerminViewModel(enumStoreOutArt myStoreOutArt)
        {
        ...
        public enumStoreOutArt_Steps CurrentStep = enumStoreOutArt_Steps.wizStepInputTermin;
