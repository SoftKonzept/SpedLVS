...
namespace LvsScan.Portable.ViewModels.Wizard
{
    ...
    {
        public delegate void SetWizardItemNextButtonEnabled(bool bEnabled);
        public SetWizardItemNextButtonEnabled delegateSetWizardItemNextButtonEnabled;
        ...
        public WizardItemViewModel(string title
                                    , Type type
                                    , BaseViewModel viewModel
                                    , bool isSkippable = false
                                    , Func<Task> customButtonAction = null
                                    , string customButtonLabel = null
                                    , params object[] additionalParameters) : this()
        {
            Title = title;
            Type = type;
        ...
        public void SetItemNextEnabled(bool bEnabled)
        {
            IsItemNextEnabeld = bEnabled;
            if (delegateSetWizardItemNextButtonEnabled != null)
            {
                delegateSetWizardItemNextButtonEnabled(bEnabled);
            }
        }

        private bool _isItemNextEnabeld;
        public bool IsItemNextEnabeld
        {
            get { return _isItemNextEnabeld; }
            set { SetProperty(ref _isItemNextEnabeld, value); }
        }
