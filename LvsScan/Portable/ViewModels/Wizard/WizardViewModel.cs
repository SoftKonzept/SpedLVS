...
namespace LvsScan.Portable.ViewModels.Wizard
{
    public class WizardViewModel : BaseViewModel
    {
        ...
        public void SetNextButtonEnabled(bool myEnabled)
        {
            IsNextEnabled = myEnabled;
        }
        ...
        public bool IsNextEnabled
        {
            ...
            set
            {
                SetProperty(ref _isNextEnabled, value);
                if (_isNextEnabled)
                {
                    //- inactiv
                    BackgroundColorNext = Color.LightGray;
                }
                else
                {
                    //- activ
                    BackgroundColorNext = Color.DodgerBlue;
                }
            }
        }

        private Color _backgroundColorNext;
        public Color BackgroundColorNext
        {
            get { return _backgroundColorNext; }
            set { SetProperty(ref _backgroundColorNext, value); }
        }
        ...
        public async Task<bool> IncreaseCurrentItemIndex(bool skip = false)
        {
            ...
            var itemViewModel = Items[_currentItemIndex].ViewModel as BaseViewModel;
