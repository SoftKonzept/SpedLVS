...
{
    public class wiz_ScanStoredLocationArticleViewModel : BaseViewModel
    {
        internal Services.api_Article apiArticle;
        internal StoredLocationStringToStoreLocationItem locItem;

        public wiz_ScanStoredLocationArticleViewModel()
        {
            this.IsBusy = false;
        ...
        public TabViewItem SelectedTabViewItem
        {
            ...
            set
            {
                ...
                if (_SelectedTabViewItem != null)
                {
                    TabScanInputSelected = (_SelectedTabViewItem.HeaderText.ToUpper().Equals("SCAN"));
                    TabManuelInputSelected = !(_SelectedTabViewItem.HeaderText.ToUpper().Equals("SCAN"));
                }

                //if ((_SelectedTabViewItem != null) && (!_SelectedTabViewItem.HeaderText.ToUpper().Equals("SCAN")))
                //{
                //    TabScanInputSelected = true;
                //    TabManuelInputSelected = false;
                //}
                //else
                //{
                //    TabManuelInputSelected = true;
                //    TabScanInputSelected = false;
                //}
            }
        }
        ...
        public async Task<ResponseStoreLocationChange> ChangeStoreLocation()
        {
            IsBusy = true;
            ...
            var result = await _apiArticle.POST_Article_Update_StoreLocation(Article);
            if (result.SuccessStoreLocationChange)
            {
                Article = result.Article.Copy();
                ArticleOriginal = result.Article.Copy();
            }
