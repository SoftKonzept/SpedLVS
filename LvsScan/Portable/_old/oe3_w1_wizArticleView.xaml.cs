...
namespace LvsScan.Portable.Views.StoreIn.Open
{
    ...
    public partial class oe3_w1_wizArticleView : ContentView, IWizardView
    {
        public oe3_wizArticleViewModel ViewModel;
        public oe3_w1_wizArticleView(BaseViewModel currentViewModel, BaseViewModel PreviousViewModel)
        {
            InitializeComponent();
            initViewModel(currentViewModel);
        }
        public oe3_w1_wizArticleView(BaseViewModel currentViewModel)
        {
            InitializeComponent();
            initViewModel(currentViewModel);
        }
        ...
        private void initViewModel(BaseViewModel currentViewModel)
        {
            ...
            if (((App)Application.Current).WizardData is WizardData)
            {
                ...
                ViewModel.WizardData.Teststring += "oe3_w1_wizArticleView " + System.Environment.NewLine;
