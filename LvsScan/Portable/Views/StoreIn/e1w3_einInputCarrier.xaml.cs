...
namespace LvsScan.Portable.Views.StoreIn
{
    ...
    public partial class e1w3_einInputCarrier : ContentView, IWizardView
    {
        public e1w3_einInputCarrierViewModel ViewModel { get; set; }
        public e1w3_einInputCarrier(BaseViewModel currentViewModel)
        {
            InitializeComponent();
            InitView(currentViewModel);
        }
        public e1w3_einInputCarrier(BaseViewModel currentViewModel, BaseViewModel PreviousViewModel)
        {
            InitializeComponent();
            InitView(currentViewModel);
        ...
        private void InitView(BaseViewModel currentViewModel)
        {
            ...
            {
                BindingContext = ViewModel = currentViewModel as e1w3_einInputCarrierViewModel;
            }
