...
namespace LvsScan.Portable.Views.StoreIn
{
    ...
    public partial class e1w2_einInputLfs : ContentView, IWizardView
    {
        public e1w2_einInputLfsViewModel ViewModel { get; set; }
        public e1w2_einInputLfs(BaseViewModel currentViewModel)
        {
            InitializeComponent();
            InitView(currentViewModel);
        }
        public e1w2_einInputLfs(BaseViewModel currentViewModel, BaseViewModel PreviousViewModel)
        {
            InitializeComponent();
            InitView(currentViewModel);
        ...
        private void InitView(BaseViewModel currentViewModel)
        {
            ...
            {
                BindingContext = ViewModel = currentViewModel as e1w2_einInputLfsViewModel;
            }
