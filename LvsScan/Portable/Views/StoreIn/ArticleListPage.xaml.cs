...
namespace LvsScan.Portable.Views.StoreIn
{
    ...
    {
        public ee2_ArticleListViewModel ViewModel;
        public ArticleListPage()
        {
            InitializeComponent();
            BindingContext = ViewModel = new ee2_ArticleListViewModel();
            ...
            if (((App)Application.Current).WizardData is WizardData)
            {
                ...
                ViewModel.WizardData.Teststring += "ArticleListPage " + Environment.NewLine;
