...
namespace LvsScan.Portable.Views.StoreIn
{
    ...
    public partial class e1w4_einInputVehicle : ContentView, IWizardView
    {
        public e1w4_einInputVehicleViewModel ViewModel { get; set; }
        public e1w4_einInputVehicle(BaseViewModel currentViewModel)
        {
            InitializeComponent();
            InitView(currentViewModel);
        }
        public e1w4_einInputVehicle(BaseViewModel currentViewModel, BaseViewModel PreviousViewModel)
        {
            InitializeComponent();
            InitView(currentViewModel);
        ...
        private void InitView(BaseViewModel currentViewModel)
        {
            ...
            {
                BindingContext = ViewModel = currentViewModel as e1w4_einInputVehicleViewModel;
            }
        ...
        private void btnWaggon_Clicked(object sender, EventArgs e)
        {
            ViewModel.IsInputWaggonEnabled = !ViewModel.IsInputWaggonEnabled;
        }

        private void inputWaggon_Completed(object sender, EventArgs e)
        {
            ViewModel.IsInputWaggonEnabled = !ViewModel.IsInputWaggonEnabled;
        }
