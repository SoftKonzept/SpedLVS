using LvsScan.Portable.EventHandlers;
...
namespace LvsScan.Portable.Views.Wizard
{
    ...
    public partial class WizardContentView : ContentView
    {
        ...
        {
            add { _viewModel.OnFinished += value; }
            remove { _viewModel.OnFinished -= value; }
        }
        ...
        // original
        //public WizardContentView(IEnumerable<WizardItemViewModel> items
        //                        , bool isAnimationEnabled = true
        //                        , string nextLabelText = null
        //                        , string backLabelText = null
        //                        , string finishLabelText = null
        //                        , string skipLabelText = null,
                                 ...
                                 Color? progressBarColor = null) : this()
        {
            ...
            item.delegateSetWizardItemNextButtonEnabled += _viewModel.SetNextButtonEnabled;
            ...
            ((BaseViewModel)(view.BindingContext)).delegateSetWizardNextButtonEnabled = item.ViewModel.delegateSetWizardNextButtonEnabled;
            item.View = view;
            ...
            _viewModel.IsNextEnabled = item.IsItemNextEnabeld;
        }
        ...
        public void Reset(IEnumerable<KeyValuePair<Type, BaseViewModel>> viewModels = null, EventHandler<WizardFinishedEventArgs> onFinishedEvent = null)
        {
            ...
            if (onFinishedEvent != null)
                _viewModel.OnFinished += onFinishedEvent;
        ...
        {
            bool bAccess = _viewModel.IsNextEnabled;
            var currentItem = _viewModel.Items[_viewModel.GetCurrentItemIndex()].ViewModel;
        ...
        private async Task UpdateCurrentItem(bool isNext, BaseViewModel previousViewModel = null)
        {
            ...
            try
            {
                ...
                //viewModel.delegateSetWizardNextButtonEnabled += SetItemNextEnabled;
                ////item.SetItemNextEnabled(true);
                string str = string.Empty;

                /// tritt hier ein Fehler auf, dann BindingContext im Viewmodel prüfen
                ((BaseViewModel)(view.BindingContext)).delegateSetWizardNextButtonEnabled = item.ViewModel.delegateSetWizardNextButtonEnabled;
            ...
            _viewModel.Title = item.Title;
            _viewModel.IsSkippable = item.IsSkippable;
            _viewModel.IsCustomButtonEnabled = item.IsCustomButtonEnabled;
            _viewModel.CustomButtonAction = item.CustomButtonAction;
            _viewModel.CustomButtonLabel = item.CustomButtonLabel;
            _viewModel.IsCustomButtonVisible = item.CustomButtonAction != null;
